<template>
  <AppLayout title="Transactions">
      ...
      <table class="tx-table">
        ...
        <tbody>
          <tr v-for="(tx, i) in payments.data" :key="tx.id">
            ...
            <td class="td-actions">
              <button v-if="tx.status === 'paid'" class="action-link" @click="showRefundModal(tx)">Refund</button>
              <button class="action-link" @click="sendReceipt(tx)">Email Receipt</button>
    ...
    <!-- Refund Modal -->
    <Modal :show="showRefundModal" title="Refund Payment" @close="showRefundModal = false">
      ...
      <template #footer>
        <button class="btn-secondary" @click="showRefundModal = false">Cancel</button>
